...
class GUIView(UIInterface, Observer):
            ...
            try:
                ...
                if member_type == "Student":
                    ...
                    if not ok:
                        ...
                        return
                    dialog.destroy()
                    messagebox.showinfo("Success", "Student added to group successfully!")
                else:
                    ...
                    dialog.destroy()
                    messagebox.showinfo("Success", f"Teacher added to group {group_val} successfully!")
    ...
    def _add_student_dialog(self) -> None:
        ...
        field_names = [
            ...
            ("subscription_status", "Subscription Status (Paid/Pending/Unpaid)"),
        ...
        btn_frame = tk.Frame(dialog, bg=COLORS["bg_main"])
        btn_frame.grid(row=len(field_names), column=0, columnspan=2, pady=20)
    ...
    def _add_event_dialog(self) -> None:
        ...
        field_names = [
            ...
            ("organizer_ids", "Organizer IDs (comma separated)"),
            ("participant_ids", "Participant IDs (comma separated)"),
        ]
